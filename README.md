...
Identifying conflicting sections in the files.

Manually editing the files to keep the required changes.

Removing Git conflict markers.

Staging the resolved files.

Committing the conflict resolution with a descriptive commit message.
